...
SUMMARY
  ...
  MIT: 354 package(s)
  Apache-2.0: 63 package(s)
  ISC: 25 package(s)
  BSD-3-Clause: 18 package(s)
  BSD-2-Clause: 9 package(s)
  MIT-0: 1 package(s)
  OFL-1.1: 1 package(s)
  Python-2.0: 1 package(s)
  UNLICENSED: 1 package(s)
  BSD*: 1 package(s)
  MIT*: 1 package(s)
  (MIT OR WTFPL): 1 package(s)
  (MIT OR GPL-3.0-or-later): 1 package(s)
  (MIT AND Zlib): 1 package(s)
  (BSD-2-Clause OR MIT OR Apache-2.0): 1 package(s)
...
### Apache-2.0
  ...
  - @balena/dockerignore@1.0.2  — https://github.com/balena-io-modules/dockerignore
  ...
  - @grpc/proto-loader@0.8.1  — https://github.com/grpc/grpc-node
  ...
  - @nut-tree-fork/nut-js@4.2.6  — https://github.com/nut-tree/nut.js
  - @nut-tree-fork/provider-interfaces@4.2.6  
  - @nut-tree-fork/shared@4.2.6  
  - @opentelemetry/api-logs@0.53.0  — https://github.com/open-telemetry/opentelemetry-js
  - @opentelemetry/api-logs@0.57.1  — https://github.com/open-telemetry/opentelemetry-js
  - @opentelemetry/api-logs@0.57.2  — https://github.com/open-telemetry/opentelemetry-js
  - @opentelemetry/api@1.9.1  — https://github.com/open-telemetry/opentelemetry-js
  - @opentelemetry/context-async-hooks@1.30.1  — https://github.com/open-telemetry/opentelemetry-js
  - @opentelemetry/core@1.30.1  — https://github.com/open-telemetry/opentelemetry-js
  - @opentelemetry/instrumentation-amqplib@0.46.1  — https://github.com/open-telemetry/opentelemetry-js-contrib
  - @opentelemetry/instrumentation-connect@0.43.0  — https://github.com/open-telemetry/opentelemetry-js-contrib
  - @opentelemetry/instrumentation-dataloader@0.16.0  — https://github.com/open-telemetry/opentelemetry-js-contrib
  - @opentelemetry/instrumentation-express@0.47.0  — https://github.com/open-telemetry/opentelemetry-js-contrib
  - @opentelemetry/instrumentation-fastify@0.44.1  — https://github.com/open-telemetry/opentelemetry-js-contrib
  - @opentelemetry/instrumentation-fs@0.19.0  — https://github.com/open-telemetry/opentelemetry-js-contrib
  - @opentelemetry/instrumentation-generic-pool@0.43.0  — https://github.com/open-telemetry/opentelemetry-js-contrib
  - @opentelemetry/instrumentation-graphql@0.47.0  — https://github.com/open-telemetry/opentelemetry-js-contrib
  - @opentelemetry/instrumentation-hapi@0.45.1  — https://github.com/open-telemetry/opentelemetry-js-contrib
  - @opentelemetry/instrumentation-http@0.57.1  — https://github.com/open-telemetry/opentelemetry-js
  - @opentelemetry/instrumentation-ioredis@0.47.0  — https://github.com/open-telemetry/opentelemetry-js-contrib
  - @opentelemetry/instrumentation-kafkajs@0.7.0  — https://github.com/open-telemetry/opentelemetry-js-contrib
  - @opentelemetry/instrumentation-knex@0.44.0  — https://github.com/open-telemetry/opentelemetry-js-contrib
  - @opentelemetry/instrumentation-koa@0.47.0  — https://github.com/open-telemetry/opentelemetry-js-contrib
  - @opentelemetry/instrumentation-lru-memoizer@0.44.0  — https://github.com/open-telemetry/opentelemetry-js-contrib
  - @opentelemetry/instrumentation-mongodb@0.51.0  — https://github.com/open-telemetry/opentelemetry-js-contrib
  - @opentelemetry/instrumentation-mongoose@0.46.0  — https://github.com/open-telemetry/opentelemetry-js-contrib
  - @opentelemetry/instrumentation-mysql2@0.45.0  — https://github.com/open-telemetry/opentelemetry-js-contrib
  - @opentelemetry/instrumentation-mysql@0.45.0  — https://github.com/open-telemetry/opentelemetry-js-contrib
  - @opentelemetry/instrumentation-nestjs-core@0.44.0  — https://github.com/open-telemetry/opentelemetry-js-contrib
  - @opentelemetry/instrumentation-pg@0.50.0  — https://github.com/open-telemetry/opentelemetry-js-contrib
  - @opentelemetry/instrumentation-redis-4@0.46.0  — https://github.com/open-telemetry/opentelemetry-js-contrib
  - @opentelemetry/instrumentation-tedious@0.18.0  — https://github.com/open-telemetry/opentelemetry-js-contrib
  - @opentelemetry/instrumentation-undici@0.10.0  — https://github.com/open-telemetry/opentelemetry-js-contrib
  - @opentelemetry/instrumentation@0.53.0  — https://github.com/open-telemetry/opentelemetry-js
  - @opentelemetry/instrumentation@0.57.1  — https://github.com/open-telemetry/opentelemetry-js
  - @opentelemetry/instrumentation@0.57.2  — https://github.com/open-telemetry/opentelemetry-js
  - @opentelemetry/redis-common@0.36.2  — https://github.com/open-telemetry/opentelemetry-js-contrib
  - @opentelemetry/resources@1.30.1  — https://github.com/open-telemetry/opentelemetry-js
  - @opentelemetry/sdk-trace-base@1.30.1  — https://github.com/open-telemetry/opentelemetry-js
  - @opentelemetry/semantic-conventions@1.27.0  — https://github.com/open-telemetry/opentelemetry-js
  - @opentelemetry/semantic-conventions@1.28.0  — https://github.com/open-telemetry/opentelemetry-js
  - @opentelemetry/semantic-conventions@1.41.1  — https://github.com/open-telemetry/opentelemetry-js
  - @opentelemetry/sql-common@0.40.1  — https://github.com/open-telemetry/opentelemetry-js-contrib
  - @prisma/instrumentation@5.22.0  — https://github.com/prisma/prisma
  - detect-libc@2.1.2  — https://github.com/lovell/detect-libc
  - docker-modem@5.0.7  — https://github.com/apocas/docker-modem
  - dockerode@5.0.0  — https://github.com/apocas/dockerode
  - import-in-the-middle@1.15.0  — https://github.com/nodejs/import-in-the-middle
  - long@5.3.2  — https://github.com/dcodeIO/long.js
  - openai@4.104.0  — https://github.com/openai/openai-node
  - tunnel-agent@0.6.0  — https://github.com/mikeal/tunnel-agent
  - xlsx@0.20.3  — https://git.sheetjs.com/SheetJS/sheetjs
...
### BSD-3-Clause
  ...
  - protobufjs@7.5.8  — https://github.com/protobufjs/protobuf.js
...
### ISC
  ...
  - pixelmatch@4.0.2  — https://github.com/mapbox/pixelmatch
...
### MIT
  ...
  - @jimp/bmp@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/core@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/custom@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/gif@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/jpeg@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/plugin-blit@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/plugin-blur@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/plugin-circle@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/plugin-color@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/plugin-contain@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/plugin-cover@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/plugin-crop@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/plugin-displace@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/plugin-dither@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/plugin-fisheye@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/plugin-flip@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/plugin-gaussian@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/plugin-invert@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/plugin-mask@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/plugin-normalize@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/plugin-print@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/plugin-resize@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/plugin-rotate@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/plugin-scale@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/plugin-shadow@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/plugin-threshold@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/plugins@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/png@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/tiff@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/types@0.22.12  — https://github.com/jimp-dev/jimp
  - @jimp/utils@0.22.12  — https://github.com/jimp-dev/jimp
  ...
  - @nut-tree-fork/node-mac-permissions@2.2.1  — https://github.com/ZachJW34/node-mac-permissions
  - @pdf-lib/standard-fonts@1.0.0  — https://github.com/Hopding/standard-fonts
  - @pdf-lib/upng@1.0.1  — https://github.com/Hopding/upng
  - @sentry-internal/browser-utils@8.55.0  — https://github.com/getsentry/sentry-javascript
  - @sentry-internal/feedback@8.55.0  — https://github.com/getsentry/sentry-javascript
  - @sentry-internal/replay-canvas@8.55.0  — https://github.com/getsentry/sentry-javascript
  - @sentry-internal/replay@8.55.0  — https://github.com/getsentry/sentry-javascript
  - @sentry/browser@8.55.0  — https://github.com/getsentry/sentry-javascript
  - @sentry/core@8.55.0  — https://github.com/getsentry/sentry-javascript
  - @sentry/electron@5.12.0  — https://github.com/getsentry/sentry-electron
  - @sentry/node@8.55.0  — https://github.com/getsentry/sentry-javascript
  - @sentry/opentelemetry@8.55.0  — https://github.com/getsentry/sentry-javascript
  ...
  - @types/node-fetch@2.6.13  — https://github.com/DefinitelyTyped/DefinitelyTyped
  - @types/node@16.9.1  — https://github.com/DefinitelyTyped/DefinitelyTyped
  - @types/node@18.19.130  — https://github.com/DefinitelyTyped/DefinitelyTyped
  ...
  - agentkeepalive@4.6.0  — https://github.com/node-modules/agentkeepalive
  ...
  - any-base@1.1.0  — https://github.com/HarasimowiczKamil/any-base
  ...
  - better-sqlite3@12.10.0  — https://github.com/WiseLibs/better-sqlite3
  ...
  - buffer-equal@0.0.1  — https://github.com/substack/node-buffer-equal
  - buffer@5.7.1  — https://github.com/feross/buffer
  - buffer@6.0.3  — https://github.com/feross/buffer
  - buildcheck@0.0.7  — https://github.com/mscdex/buildcheck
  ...
  - clipboardy@2.3.0  — https://github.com/sindresorhus/clipboardy
  ...
  - docx@8.5.0  — https://github.com/dolanmiu/docx
  ...
  - file-type@16.5.4  — https://github.com/sindresorhus/file-type
  ...
  - form-data-encoder@1.7.2  — https://github.com/octet-stream/form-data-encoder
  - form-data@4.0.5  — https://github.com/form-data/form-data
  - formdata-node@4.4.1  — https://github.com/octet-stream/form-data
  ...
  - gifwrap@0.10.1  — https://github.com/jtlapp/gifwrap
  ...
  - hono@4.12.19  — https://github.com/honojs/hono
  ...
  - humanize-ms@1.2.1  — https://github.com/node-modules/humanize-ms
  - iconv-lite@0.6.3  — https://github.com/ashtuchkin/iconv-lite
  - iconv-lite@0.7.2  — https://github.com/pillarjs/iconv-lite
  - image-q@4.0.0  — https://github.com/ibezkrovnyi/image-quantization
  - image-size@1.2.1  — https://github.com/image-size/image-size
  ...
  - isomorphic-fetch@3.0.0  — https://github.com/matthew-andrews/isomorphic-fetch
  - jimp@0.22.10  — https://github.com/jimp-dev/jimp
  - jose@6.2.3  — https://github.com/panva/jose
  - js-yaml@4.1.1  — https://github.com/nodeca/js-yaml
  - jsdom@24.1.3  — https://github.com/jsdom/jsdom
  ...
  - long-timeout@0.1.1  — https://github.com/tellnes/long-timeout
  - luxon@3.7.2  — https://github.com/moment/luxon
  ...
  - nanoid@5.1.11  — https://github.com/ai/nanoid
  ...
  - node-addon-api@5.0.0  — https://github.com/nodejs/node-addon-api
  ...
  - node-schedule@2.1.1  — https://github.com/node-schedule/node-schedule
  ...
  - omggif@1.0.10  — https://github.com/deanm/omggif
  ...
  - pdf-parse@1.1.4  — https://github.com/mehmet-kozan/pdf-parse
  - peek-readable@4.1.0  — https://github.com/Borewit/peek-readable
  - pg-protocol@1.14.0  — https://github.com/brianc/node-postgres
  ...
  - pngjs@3.4.0  — https://github.com/lukeapage/pngjs2
  ...
  - pptxgenjs@3.12.0  — https://github.com/gitbrent/PptxGenJS
  ...
  - queue@6.0.2  — https://github.com/jessetane/queue
  ...
  - readable-web-to-node-stream@3.0.4  — https://github.com/Borewit/readable-web-to-node-stream
  ...
  - rrweb-cssom@0.7.1  — https://github.com/rrweb-io/CSSOM
  ...
  - sorted-array-functions@1.3.0  — https://github.com/mafintosh/sorted-array-functions
  - ssh2@1.17.0  — https://github.com/mscdex/ssh2
  ...
  - strtok3@6.3.0  — https://github.com/Borewit/strtok3
  ...
  - timm@1.7.1  — https://github.com/guigrpa/timm
  - tiny-typed-emitter@2.1.0  — https://github.com/binier/tiny-typed-emitter
  - tinycolor2@1.6.0  — https://github.com/bgrins/TinyColor
  - toidentifier@1.0.1  — https://github.com/component/toidentifier
  - token-types@4.2.1  — https://github.com/Borewit/token-types
  ...
  - utif2@4.1.0  — https://github.com/photopea/UTIF.js
  ...
  - web-streams-polyfill@4.0.0-beta.3  — https://github.com/MattiasBuelens/web-streams-polyfill
...
### OFL-1.1
  ...
  - @fontsource/marcellus@5.2.8  — https://github.com/fontsource/font-files
