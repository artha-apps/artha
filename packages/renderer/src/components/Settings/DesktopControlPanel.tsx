    ...
    <div className="flex-1 overflow-y-auto p-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex items-center justify-between px-4 py-4 mb-6 rounded-xl bg-artha-s2 border border-artha-border">
          <div>
            <p className="text-sm font-semibold text-white">Enable desktop control</p>
        ...
        <div className="mb-6">
          <button
            ...
            disabled={busy}
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-cyan-600 hover:bg-cyan-500 disabled:opacity-40 disabled:cursor-not-allowed text-white text-sm font-medium transition-colors"
          >
